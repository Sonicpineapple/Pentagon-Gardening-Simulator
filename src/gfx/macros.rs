macro_rules! include_wgsl {
    ($file_path:literal $(, $var:ident)* $(,)?) => {
        ::eframe::wgpu::ShaderModuleDescriptor {
        ...
        impl<$lt> $crate::gfx::bindings::BindGroupsTrait<$lt> for $bindings_struct_name<$lt> {
            const BINDINGS: &'static [$crate::gfx::bindings::BindingMetadata] = &[$({
                $crate::gfx::bindings::BindingMetadata {
                    visibility: ::eframe::wgpu::ShaderStages::$visibility,
                    ..$binding_data
                }
            }),*];

            fn binding_resources(self) -> Vec<::eframe::wgpu::BindingResource<$lt>> {
...
macro_rules! pipeline {
    ($vis:vis struct $pipeline_name:ident {
        ...
        $vis struct $pipeline_name {
            ...
            pub device: ::std::sync::Arc<::eframe::wgpu::Device>,
            pub label: String,
            pub bind_group_layouts: Vec<::eframe::wgpu::BindGroupLayout>,
        }
        ...
        impl $pipeline_name {
            pub fn new<$bindings_lt, $( $($($pipeline_params_lt),*)? )?> (
                device: &::std::sync::Arc<::eframe::wgpu::Device>,
                shader_module: &::eframe::wgpu::ShaderModule,
